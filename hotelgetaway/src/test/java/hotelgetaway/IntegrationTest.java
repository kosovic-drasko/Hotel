...
import hotelgetaway.HotelgetawayApp;
import hotelgetaway.config.AsyncSyncConfiguration;
import hotelgetaway.config.EmbeddedSQL;
...
@SpringBootTest(classes = { HotelgetawayApp.class, AsyncSyncConfiguration.class })
@EmbeddedSQL
